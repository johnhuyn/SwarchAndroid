...
void setup()
{
  ...
  nameField = new APEditText(displayWidth/2 - 30, displayHeight/2 - 65, 150, 50); //create a textfield from x- and y-pos., width and height
  ...
  passwordField = new APEditText(displayWidth/2 - 30, displayHeight/2 - 10, 150, 50); //create a textfield from x- and y-pos., width and height
